      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 reveal-on-scroll">
          <h2 className="font-display font-bold text-3xl sm:text-4xl text-slate-900 dark:text-white">
            Let's Collaborate & <span className="text-gradient-purple-cyan">Connect</span>
          </h2>
          ...
          <p className="text-slate-600 dark:text-gray-400 mt-4 text-sm sm:text-base font-light">
            Have a project in mind, want to discuss software development opportunities, or just want to say hi? Write to me directly!
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-between reveal-left">
            <div className="space-y-6">
              ...
              <p className="text-slate-600 dark:text-gray-400 text-sm font-light leading-relaxed">
                Click any communication method below to start a direct connection, or click the copy icon to copy details to your clipboard.
              </p>
              ...
              <div className="space-y-4">
                {contactInfo.map((info) => (
                  ...
                  >
                    ...
                    >
                      <div className={`p-3 rounded-xl bg-slate-100 dark:bg-white/2.5 transition-colors ${info.color}`}>
                        {info.icon}
                      </div>
                      <div>
                        <div className="text-xs text-slate-500 dark:text-gray-400 font-medium">{info.type}</div>
            ...
            <div className="p-5 rounded-2xl glass-panel border border-slate-200 dark:border-white/5 flex items-center gap-4 text-xs text-slate-500 dark:text-gray-400 font-light mt-6 lg:mt-0">
              ...
              <span>Standard response time: Typically responds within 3 hours.</span>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="name" className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wide">Name</label>
                    <input 
                      type="text" 
                      id="name"
                      required
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="email" className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wide">Email</label>
                    <input 
                      type="email" 
                      id="email"
                      required
                ...
                <div className="space-y-1.5">
                  <label htmlFor="message" className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wide">Message</label>
                  <textarea 
                    id="message"
                    required
                    rows="5"
                ...
                {submitted ? (
                  <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs sm:text-sm flex items-center gap-2.5 animate-pulse">
                    <Check size={18} />
                    Message sent successfully! Thank you, I'll get back to you shortly.
                  </div>
                ) : (
                  <button 
                    type="submit"
                    className="w-full py-4 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-500 hover:to-cyan-500 text-white transition-all duration-300 shadow-md shadow-purple-500/20 hover:scale-101 active:scale-99 cursor-pointer"
                  >
                    Send Message
